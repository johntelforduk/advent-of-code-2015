# Solution to part 2 of day 15 of AOC 2015, Science for Hungry People
...
for f in range(101):
    for c in range(101):
        for b in range(101):
            ...
            if (s >= 0
                and (f * calories['Frosting'] + c * calories['Candy']
                     + b * calories['Butterscotch'] + s * calories['Sugar']) == 500):
                score = 1
